...
%     sigma_acc = 0.5;
    ...
    [ x_pri_v2, x_pos_v2, t_dat_v2 ] = kf_3_kmus_v3_simplified(x0, P, ...
...
%     Your target data / ideal data can be accessed below
...
%      'qLSK', ideal.qLSK(idx,:));
    ...
    actState = [ideal.MIDPEL gfr_vel_MP_act ideal.qRPV ... 
                ideal.LTIO gfr_vel_LA_act ideal.qLSK ...
                ideal.RTIO gfr_vel_RA_act ideal.qRSK];
    
    writetable(struct2table(ideal), 'ideal.csv');
    datainput = table(gfr_acc_MP_act, gfr_acc_LA_act, gfr_acc_RA_act, ...
        bIsStatMP, bIsStatLA, bIsStatRA, ...
        qPelvisEst, qLankleEst, qRankleEst);
    writetable(datainput, 'datainput.csv');