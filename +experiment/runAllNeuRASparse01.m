...
%                'accData', 'w__s', 'oriData', 'w__s', 'accDataNoise', 0, ...
%                'initSrc', 'w__v', 'stepDetection', 'av03', ...
%                'applyMeas', 202, 'applyCstr', 355, 'P', 0.5, ...
%                'sigmaQAcc', 1e1);
    setups{end+1} = struct('est', 'pfv1', ...
               'accData', 'w__v', 'oriData', 'w__v', 'accDataNoise', 0, ...
               'initSrc', 'w__v', 'stepDetection', 'av03', ...
               'applyPred', 001, 'applyMeas', 001, ...
               'P', false, 'sigmaQAcc', 1e1);
%     for mI = [76]
%         setups{end+1} = struct('est', 'ekfv3', ...
%                            'accData', 'w__s', 'oriData', 'w__s', 'accDataNoise', 0, ...
%                            'initSrc', 'w__v', 'stepDetection', 'av01', ...
%                            'applyMeas', mI, 'applyCstr', 355, 'P', 0.5, ...
%                            'sigmaQAcc', 1e1);
%         setups{end+1} = struct('est', 'ekfv3', ...
%                            'accData', 'w__s', 'oriData', 'w__v', 'accDataNoise', 0, ...
...
%                 setups{end+1} = struct('est', 'ekfv3', ...
%                            'accData', 'w__s', 'oriData', 'w__s', 'accDataNoise', 0, ...
%                            'initSrc', 'w__x', 'stepDetection', sdI, ...
%                            'applyMeas', mI, 'applyCstr', cI, 'P', 0.5, ...
%                            'sigmaQAcc', 1e1);
%             end
%         end
...
function label = getLabel(ns, setup)
    ...
    if strcmp(setup.est, 'ekfv3')
        ...
        label = sprintf("%s+%s+A%sO%sI%s+S%s+P%03d+M%03d", ns, setup.est, ...
            aD, setup.oriData, setup.initSrc, ...
            setup.stepDetection, setup.applyPred, setup.applyMeas);
    end
end