...
dataList = { ...
    struct('subj', 'S10', 'act', 'Trial-Walk-2'), ...
    struct('subj', 'S10', 'act', 'Trial-Zigzag-1'), ...
    struct('subj', 'S03', 'act', 'Trial-JumpingJacks-1'), ...
    struct('subj', 'S04', 'act', 'Trial-HighKneeJog-2'), ...
    struct('subj', 'S07', 'act', 'Trial-Fivemin-2'), ...
};
