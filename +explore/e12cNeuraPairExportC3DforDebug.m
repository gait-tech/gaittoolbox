...
%              'algo2', "NS2+lieekfv1+Aw__sOw__sIw__v+Sav03+P023+M131+C007", ...
%              'name', "NS2+Aw__sOw__sIw__v+Sav03+CKFvsLieEKF"), ...
      struct('file', 'S01-Trial-Walk-1', ...
             'algo1', "NS2+lieekfv1+Aw__sOw__sIw__v+Sav03+P023+M121+C007", ...
             'algo2', "NS2+lieekfv1+Aw__sOw__sIw__v+Sav03+P023+M101+C007", ...
             'name', "NS2+Aw__sOw__sIw__v+Sav03+CKFvsLieEKF"), ...
};
ns = "NS2";
...
%     estBody1S2S = estBody1Rel.toWorldFrame(vb.MIDPEL, vb.qRPV);
    ...
    sensors = experiment.buildVelCstrDebug(sensors, estBody1);
    sensorsDebug = experiment.buildVelCstrDebug(sensorsDebug, estBody1Debug);
    ...
    % velocity constraint debug
    sensors = experiment.buildVelCstrDebug(sensors, estBody2, 'Ref');
    sensorsDebug = experiment.buildVelCstrDebug(sensorsDebug, estBody2Debug, 'Ref');
