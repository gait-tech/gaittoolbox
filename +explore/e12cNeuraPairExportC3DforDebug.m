...
for sI = [struct('pI', 1, 'mI', 104, 'cI', 0), ...
          struct('pI', 1, 'mI', 104, 'cI', 7), ...
          struct('pI', 1, 'mI', 114, 'cI', 7), ...
          struct('pI', 1, 'mI', 124, 'cI', 7), ...
          struct('pI', 1, 'mI', 134, 'cI', 7), ...
          struct('pI', 1, 'mI', 105, 'cI', 7), ...
          struct('pI', 1, 'mI', 115, 'cI', 7), ...
          struct('pI', 1, 'mI', 125, 'cI', 7), ...
          struct('pI', 1, 'mI', 135, 'cI', 7), ...
              ] 
    list{end+1} = struct('file', 'S01-Trial-Walk-1', ...
         'algo1', sprintf("NS2+lieekfv1+Aw__sOw__sIw__v+Sav03+P%03d+M%03d+C%03d", ...
                          sI.pI, sI.mI, sI.cI), ...
         'algo2', sprintf("NS2+lieekfv2+Aw__sOw__sIw__v+Sav03+P%03d+M%03d+C%03d", ...
                          sI.pI, sI.mI, sI.cI), ...
