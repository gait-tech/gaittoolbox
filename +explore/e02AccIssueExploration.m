...
clf; pelib.viz.plotComparison(estAccMP1, actAccMP1, fs);

updateFigureContents('LA Acc');
clf; pelib.viz.plotComparison(estAccLA1, actAccLA1, fs);

updateFigureContents('RA Acc');
clf; pelib.viz.plotComparison(estAccRA1, actAccRA1, fs);
