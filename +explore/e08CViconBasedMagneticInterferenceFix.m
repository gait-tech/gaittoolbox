...
legend(sprintf('Left  Opt at %.1f%c (%.2f)', thetaL, char(176), errL(peakIdxL)), ...
       sprintf('Left  Cal at %.1f%c (%.2f)', calibThetaL(1), char(176), errL(calibIdxL)), ...
       sprintf('Left  Cal2 at %.1f%c (%.2f)', calib2ThetaL(1), char(176), errL(calib2IdxL)), ...
       sprintf('Right Opt at %.1f%c (%.2f)', thetaR, char(176), errR(peakIdxR)), ...
       sprintf('Right Cal at %.1f%c (%.2f)', calibThetaR(1), char(176), errR(calibIdxR)), ...
       sprintf('Right Cal2 at %.1f%c (%.2f)', calib2ThetaR(1), char(176), errR(calib2IdxR)) );
