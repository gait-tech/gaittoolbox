...
ns = "NS2";
algoList = {"NS2+pfv1+Aw__vOw__vIw__v+Sav03+P002+M006", ...
        "NS2+pfv1+Aw__sOw__sIw__v+Sav03+P002+M006" };
velThreshold = 0.1;
...
for algoI = algoList
    ...
    for i = 15 % [1 5 15]
        ...
        vel = estBody.calcJointVel({'MIDPEL', 'LTIO', 'RTIO'});
        sensors.PELVVel = vel.MIDPEL;
        sensors.LANKVel = vel.LTIO;
        sensors.RANKVel = vel.RTIO;
