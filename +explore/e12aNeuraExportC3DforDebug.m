...
%      % debug
%       struct('file', 'S01-Trial-Walk-1', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M66+C393"), ...
%       struct('file', 'S01-Trial-Zigzag-2', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M76+C395"), ...
      struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M76+C393"), ...
%       struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M76+C385"), ...
%       struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M76+C355"), ...
%       struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M76+C375"), ...
%       struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M64+C393"), ...
%       struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M66+C393"), ...
    % london demo
