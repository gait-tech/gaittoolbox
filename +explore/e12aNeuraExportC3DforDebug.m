...
list = {
    ...
    struct('file', 'S02-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S03-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S04-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S05-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S06-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S07-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S08-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S09-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
    struct('file', 'S10-Trial-Walk-1', 'algo', 'NS1+Av__sOv__sIv__v+M02+C201'), ...
