...
%      % debug
%     struct('file', 'S07-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M02+C157"), ...
%     struct('file', 'S07-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M02+C158"), ...
    struct('file', 'S07-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M02+C151"), ...
    struct('file', 'S07-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M02+C355"), ...
%     struct('file', 'S07-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M06+C161"), ...
%     struct('file', 'S02-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M05+C151"), ...
%     struct('file', 'S02-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M05+C161"), ...
%     struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M05+C151"), ...
%     struct('file', 'S02-Trial-Walk-2', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M05+C161"), ...
%     struct('file', 'S07-Trial-Walk-1', 'algo', "NS1+Aw__sOw__sIw__x+Sav01+M02+C175"), ...
    % london demo
