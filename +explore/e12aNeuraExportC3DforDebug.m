...
for i = [15]
    ...
    for sI = [struct('pI', 21, 'mI', 135, 'cI', 7), ...
             struct('pI', 21, 'mI', 335, 'cI', 7), ...  
             struct('pI', 21, 'mI', 535, 'cI', 7), ...
             struct('pI', 21, 'mI', 135, 'cI', 17), ...
             struct('pI', 21, 'mI', 135, 'cI', 27), ...
             struct('pI', 63, 'mI', 131, 'cI', 7), ...
             struct('pI', 63, 'mI', 331, 'cI', 7), ...
             struct('pI', 63, 'mI', 531, 'cI', 7), ...
             struct('pI', 63, 'mI', 131, 'cI', 17), ...
             struct('pI', 63, 'mI', 131, 'cI', 27)] 
         list{listN+1} = struct('file', name, ...
             'algo', sprintf("NS2+lieekfv1+Aw__sOw__sIw__v+Sav03+P%03d+M%03d+C%03d", ...
                     sI.pI, sI.mI, sI.cI));
         listN = listN+1;
    end
end
