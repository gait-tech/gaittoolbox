...
%     struct('file', 'S01-Trial-JumpingJacks-1', 'algo', 'NS1+Aw__sOw__sIw__x+Sav01+M02+C176'), ...
     % others
    struct('file', 'S01-Trial-Static-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M02+C178"), ...
    struct('file', 'S01-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M02+C178"), ...
    struct('file', 'S01-Trial-TUG-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M02+C178"), ...
