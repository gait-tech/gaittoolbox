...
%     struct('file', 'S08-Trial-Fivemin-1', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M56+C395"), ...
      struct('file', 'S08-Trial-Walk-1', 'algo', "NS1+Aw__sOw__sIw__v+Sav01+M66+C395"), ...
%     struct('file', 'S03-Trial-Static-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M52+C383"), ...
%     struct('file', 'S10-Trial-Static-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M52+C383"), ...
%     struct('file', 'S07-Trial-Walk-2', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M52+C383"), ...
%     struct('file', 'S10-Trial-Walk-2', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M52+C383"), ...
%     struct('file', 'S08-Trial-Walk-1', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M52+C383"), ...
%     struct('file', 'S08-Trial-JumpingJacks-2', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M52+C383"), ...
%     struct('file', 'S03-Trial-JumpingJacks-2', 'algo', "NS1+Av__sOv__sIv__v+Sav01+M52+C383"), ...
%     struct('file', 'S02-Trial-JumpingJacks-2', 'algo', "NS1+Av__sOv__sIv__v+Sav02+M52+C383"), ...
    % london demo
...
for lIdx=1:length(list)
    ...
    load(sprintf('neura-sparse01/explore-v2/neura-%s-%s.mat', list{lIdx}.file, list{lIdx}.algo));
