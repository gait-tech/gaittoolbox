% motion list
list = {
    struct('subj', 's1', 'act', 'walking1', 'algo', 'Dxx+M02+C201'), ...
    struct('subj', 's1', 'act', 'walking1', 'algo', 'Dxx+M02+C202'), ...
    struct('subj', 's1', 'act', 'walking1', 'algo', 'Dxx+M02+C172'), ...
    struct('subj', 's1', 'act', 'walking1', 'algo', 'Dvx+M02+C202'), ...
    struct('subj', 's1', 'act', 'walking1', 'algo', 'Dxv+M02+C202'), ...
    struct('subj', 's1', 'act', 'walking1', 'algo', 'Dvv+M02+C202'), ...
};
