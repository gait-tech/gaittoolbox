...
%     Q_acc = 0;
    ...
    [ x_pri_v2, x_pos_v2, t_dat_v2 ] = kf_3_kmus_v2(fs, ...
        Q_acc, Q_acc, Q_acc, P, ...
        x0_pos_MP, x0_vel_MP, gfr_acc_MP_act(sIdx:end,:), ...
        bIsStatMP_act(sIdx:end,:), qPelvisAct(sIdx+1:end,:), ...
        x0_pos_LA, x0_vel_LA, gfr_acc_LA_act(sIdx:end,:), ...
        bIsStatLA_act(sIdx:end,:), qLankleAct(sIdx+1:end,:), ...
        x0_pos_RA, x0_vel_RA, gfr_acc_RA_act(sIdx:end,:), ...
        bIsStatRA_act(sIdx:end,:), qRankleAct(sIdx+1:end,:), ...
    ...
    [ x_pri_v2, x_pos_v2, t_dat_v2 ] = kf_3_kmus_v2(fs, ...
        Q_acc, Q_acc, Q_acc, P, ...
        x0_pos_MP, x0_vel_MP, gfr_acc_MP_act(sIdx:end,:), ...
        bIsStatMP_act(sIdx:end,:), qPelvisEst(sIdx:end,:), ...
        x0_pos_LA, x0_vel_LA, gfr_acc_LA_act(sIdx:end,:), ...
        bIsStatLA_act(sIdx:end,:), qLankleEst(sIdx:end,:), ...
        x0_pos_RA, x0_vel_RA, gfr_acc_RA_act(sIdx:end,:), ...
        bIsStatRA_act(sIdx:end,:), qRankleEst(sIdx:end,:), ...
        d_pelvis, d_lfemur, d_rfemur, d_ltibia, d_rtibia, uwb_mea, ...
        true, false, true, false, false);
    ...
    [ x_pri_v2, x_pos_v2, t_dat_v2 ] = kf_3_kmus_v2(fs, ...
        Q_acc, Q_acc, Q_acc, P, ...
        x0_pos_MP, x0_vel_MP, gfr_acc_MP(sIdx:end-1,:), ...
        bIsStatMP_act(sIdx:end,:), qPelvisAct(sIdx+1:end,:), ...
        x0_pos_LA, x0_vel_LA, gfr_acc_LA(sIdx:end-1,:), ...
        bIsStatLA_act(sIdx:end,:), qLankleAct(sIdx+1:end,:), ...
        x0_pos_RA, x0_vel_RA, gfr_acc_RA(sIdx:end-1,:), ...
        bIsStatRA_act(sIdx:end,:), qRankleAct(sIdx+1:end,:), ...
        d_pelvis, d_lfemur, d_rfemur, d_ltibia, d_rtibia, uwb_mea, ...
        true, false, true, false, false);
    ...
    % Hinge Knee Joint + ZUPT, Xsens pos filt, Vicon ori
    [ x_pri_v2, x_pos_v2, t_dat_v2 ] = kf_3_kmus_v2(fs, ...
        Q_acc, Q_acc, Q_acc, P, ...
        x0_pos_MP, x0_vel_MP, gfr_acc_MP_filt(sIdx:end-1,:), ...
        bIsStatMP_act(sIdx:end,:), qPelvisAct(sIdx+1:end,:), ...
        x0_pos_LA, x0_vel_LA, gfr_acc_LA_filt(sIdx:end-1,:), ...
        bIsStatLA_act(sIdx:end,:), qLankleAct(sIdx+1:end,:), ...
        x0_pos_RA, x0_vel_RA, gfr_acc_RA_filt(sIdx:end-1,:), ...
        bIsStatRA_act(sIdx:end,:), qRankleAct(sIdx+1:end,:), ...
        d_pelvis, d_lfemur, d_rfemur, d_ltibia, d_rtibia, uwb_mea, ...
        true, false, true, false, false);
    ...
    % Hinge Knee Joint + ZUPT, Xsens pos filt, Xsens ori
    [ x_pri_v2, x_pos_v2, t_dat_v2 ] = kf_3_kmus_v2(fs, ...
        Q_acc, Q_acc, Q_acc, P, ...
        x0_pos_MP, x0_vel_MP, gfr_acc_MP_filt(sIdx:end-1,:), ...
        bIsStatMP_act(sIdx:end,:), qPelvisEst(sIdx:end-1,:), ...
        x0_pos_LA, x0_vel_LA, gfr_acc_LA_filt(sIdx:end-1,:), ...
        bIsStatLA_act(sIdx:end,:), qLankleEst(sIdx:end-1,:), ...
        x0_pos_RA, x0_vel_RA, gfr_acc_RA_filt(sIdx:end-1,:), ...
        bIsStatRA_act(sIdx:end,:), qRankleEst(sIdx:end-1,:), ...
        d_pelvis, d_lfemur, d_rfemur, d_ltibia, d_rtibia, uwb_mea, ...
        true, false, true, false, false);
    ...
    for hjcIdx = 2:2
        ...
        % Hinge Knee Joint (special) + ZUPT, Xsens pos, Xsens ori
        [ x_pri_v2, x_pos_v2, t_dat_v2 ] = kf_3_kmus_v2(fs, ...
            Q_acc, Q_acc, Q_acc, P, ...
            x0_pos_MP, x0_vel_MP, gfr_acc_MP(sIdx:end-1,:), ...
            bIsStatMP_act(sIdx:end,:), qPelvisEst(sIdx:end,:), ...
