% ======================================================================
%> @brief Load mat file generated by parseViconCSV.py and 
%> return an instance of ViconBody class
%>
...
function obj = loadViconMat(fname)   
    ...
    obj = mocapdb.ViconBody('srcFileName', fname, 'posUnit', 'mm', ...
        'LFEP', LHJC, 'LFEO', LKJC, 'LTIO', LAJC, 'LTOE', LTOE, ...
        'RFEP', RHJC, 'RFEO', RKJC, 'RTIO', RAJC, 'RTOE', RTOE, ...
        'PELV', (RASI+LASI)/2, 'fs', 100, 'frame', 'vicon');
