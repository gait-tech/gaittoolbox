...
%   testPos = cumtrapz([1:N_MP]/fs,vel_act_rel_MPFR(k, 1:N_MP));
%   plot((1:N_MP)/fs, testPos(1:N_MP))
%   testPos = cumtrapz([1:N_MP]/fs,vel_rec_rel_MPFR(k, 1:N_MP));
%   plot((1:N_MP)/fs, testPos(1:N_MP))
