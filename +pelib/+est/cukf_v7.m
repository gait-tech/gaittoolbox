%% cukf_v7 (included angular velocity in state, first using last timestep as 
...
%no "vel-level" constraint for knee joint, nor use of a priori est using
%q(k+1) =  q(k) + w*dt. will come in v8 and v9, respectively

%v10 will include accel bias in state/zero-velocity-update

% ***SPECIAL NOTE FOR v7: x containts [pos, vel, accel, quat, ang. vel.]' of each sensor
...
function [ x_rec, xa_rec, qFEM ] = cukf_v7(x,P,Q,R,N_MP,nMeas,acc,fs,...
