...
%            'zupt', 0, 'cstr', 0, 'P', 0.5), ...
%     struct('label', 'Dxxx+ZUPT', 'est', 'ekfv3', ...
%            'accData', 'x', 'oriData', 'x', 'zuptData', 'x', ...
%            'zupt', 1, 'cstr', 0, 'P', 0.5), ...
%     struct('label', 'Dxxx+UWB', 'est', 'ekfv3', ...
%            'accData', 'x', 'oriData', 'x', 'zuptData', 'x', ...
%            'zupt', 0, 'cstr', 0, 'uwb', 1, 'P', 0.5), ...
%     struct('label', 'Dxxx+ZUPT+UWB', 'est', 'ekfv3', ...
%            'accData', 'x', 'oriData', 'x', 'zuptData', 'x', ...
%            'zupt', 1, 'cstr', 0, 'uwb', 1, 'P', 0.5), ...
% };
setups = {
    struct('label', 'Dxxx+ZUPT2', 'est', 'ekfv3', ...
       'accData', 'x', 'oriData', 'x', 'zuptData', 'x', ...
       'zupt', 2, 'cstr', 0, 'P', 0.5), ...
};
for cI=[1:5]
    setups{end+1} = struct('label', sprintf('Dxxx+ZUPT2+C%03d', cI), ...
           'est', 'ekfv3', ...
           'accData', 'x', 'oriData', 'x', 'zuptData', 'x', ...
           'zupt', 2, 'cstr', cI, 'P', 0.5);
end
...
% end
% for cI=[1:4 11:12 14:15 21:22 31:32 34:35 101:102 104:105]
% for cI=[1:4 11:12 14:15 21:22 31:32 34:35]
%     setups{end+1} = struct('label', sprintf('Dxxx+ZUPT+UWB+C%03d', cI), ...
%            'est', 'ekfv3', ...
%            'accData', 'x', 'oriData', 'x', 'zuptData', 'x', ...
%            'zupt', 1, 'cstr', cI, 'uwb', 1, 'P', 0.5);
% end
